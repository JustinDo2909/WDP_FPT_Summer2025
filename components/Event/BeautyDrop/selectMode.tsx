        ...
        <Section className="space-y-6">
          <Block className="grid md:grid-cols-2 gap-6">
            {Object.entries(gameModes).map(([key, mode]) => (
              ...
              >
                <Box className="text-center pb-2 flex flex-row justify-between items-center gap-2">
                  <Group className="flex items-center justify-center gap-2">
                    ...
                    <RText
                      className={`text-lg font-bold ${key === "practice" ? "text-green-800" : "text-purple-800"}`}
                    >
                      {mode.name}
                    </RText>
                  </Group>
                  <RText
                    className={`${key === "practice" ? "text-green-700" : "text-purple-700"} text-sm font-medium`}
                  >
                    {mode.description}
                  </RText>
                </Box>
                ...
                <Box className="bg-white shadow-inner border border-gray-200 rounded-md text-center py-2 px-4 mb-3">
                  <RText className="text-base font-bold text-gray-700 tracking-wider">
