...
const posts = [
  ...
  },
  {
    ...
    avatar: "https://ui-avatars.com/api/?name=Emma+Rodriguez&background=FCE7F3&color=BE185D",
    time: "4 hours ago", 
  ...
  },
  {
    id: 3,
    author: "Marcus Kim",
    avatar: "https://ui-avatars.com/api/?name=Marcus+Kim&background=EDE9FE&color=8B5CF6",
    time: "6 hours ago",
  ...
  },
  {
    ...
    avatar: "https://ui-avatars.com/api/?name=Lisa+Thompson&background=FDF2F8&color=EC4899",
    time: "8 hours ago",
  ...
  },
  {
    ...
    avatar: "https://ui-avatars.com/api/?name=Dr+James+Park&background=F5F3FF&color=7C3AED",
    time: "12 hours ago",
    title: "Gentle Cleanser Technique: Protecting Your Skin Barrier",
    thumbnail: "https://images.unsplash.com/photo-1556228852-80de0ce30b4b?w=300&h=200&fit=crop",
    content: [
  ...
  },
  {
    ...
    avatar: "https://ui-avatars.com/api/?name=Michelle+Wong&background=FCEDF2&color=BE185D",
    time: "1 day ago",
    title: "Hyaluronic Acid Serum: Maximizing Hydration Benefits",
    thumbnail: "https://images.unsplash.com/photo-1556228720-da4e85b59fcd?w=300&h=200&fit=crop",
    content: [
      ...
      <Container className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <Column className="mb-8 sm:mb-12 text-center">
          ...
          <RText className="text-base sm:text-lg text-gray-600 mx-auto px-4">
            Learn the proper techniques and application methods for your favorite skincare products
          </RText>
        </Column>
        ...
        <Section className="bg-gray-100 rounded-2xl p-4 sm:p-6 lg:p-8">
          <Row className="flex flex-wrap gap-4 sm:gap-6 lg:gap-8">
            {posts.map(post => (
              <Section key={post.id} className="w-full sm:w-[calc(50%-12px)] lg:w-[calc(33.333%-22px)] min-w-0">
